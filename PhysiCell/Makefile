...
PhysiCell_custom_module_OBJECTS := custom.o submodel_data_structures.o internal_viral_dynamics.o internal_viral_response.o \
receptor_dynamics.o immune_submodels.o epithelium_submodel.o 
